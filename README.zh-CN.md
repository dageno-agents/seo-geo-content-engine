...
# SEO GEO Content Engine 中文说明

> 从关键词或内容 brief 出发，生成更完整的 SEO/GEO 内容生产包。

## 它解决什么问题

- 很多 AI 写作只输出一篇正文，但真正发布还需要搜索意图、结构、FAQ、metadata、GEO 包装和质量检查。
- 这个项目把研究、结构、正文、FAQ、元数据和 AI-friendly 版本串成一条内容流水线。

## 什么时候用它

- 你已经有关键词、主题或内容 brief。
- 你需要批量生产 SEO/GEO 文章，但仍然想保留搜索质量。
- 你希望输出不仅有正文，还有元数据、FAQ 和 answer-engine 友好的版本。

## 和相邻项目有什么区别

- 它从“关键词/brief”进入内容生产。
- `geo-content-writer` 从“Dageno fanout/backlog row”进入文章生产。
- `dageno-online-topic-prompt-generator` 负责前面的 Topic/Prompt 生成，不负责完整写作流水线。
...
- metadata
- FAQ schema ideas
- GEO-friendly content variants

## 快速开始

1. 查看 `skills/programmatic-seo-writer.md`。
2. 准备目标关键词、受众、品牌要求和参考资料。
3. 按 workflow 生成研究、结构、正文和发布资产。
